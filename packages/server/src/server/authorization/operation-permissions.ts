...
export const INBOUND_PERMISSION = {
  ...
  "code_collab.all_changes.get_diff.request": "workspace.read",
  "code_collab.turn_diff.get_files.request": "workspace.read",
  "code_collab.turn_diff.list_turns.request": "workspace.read",
  "collab.members.list.request": "workspace.read",
  "collab.members.remove.request": "workspace.manage",
  "collab.members.set.request": "workspace.manage",
  "collab.presence.beat.request": "workspace.read",
  "collab.workspace.enable.request": "workspace.manage",
  "collab.turn.send.request": "workspace.write",
  "collab.turn.cancel.request": "workspace.write",
  "collab.timeline.get.request": "workspace.read",
  "collab.stream.token.request": "workspace.read",
  "collab.subscription.poll.request": "workspace.read",
  ...
  "daemon.runtime.get_status.request": "daemon.read",
  "daemon.runtime.install.request": "daemon.manage",
  "local_plane.attach_token.create.request": "workspace.write",
  "orchestration.operation.cancel.request": "workspace.write",
  "orchestration.operation.get.request": "workspace.read",
  "orchestration.operation.list.request": "workspace.read",
  ...
  "enterprise.browser.page_identity.observe.request": "workspace.read",
  "enterprise.browser.page_identity.invalidate.request": "workspace.read",
...
export const OUTBOUND_PERMISSION = {
  ...
  "code_collab.all_changes.get_diff.response": "workspace.read",
  "code_collab.turn_diff.get_files.response": "workspace.read",
  "code_collab.turn_diff.list_turns.response": "workspace.read",
  "collab.members.list.response": "workspace.read",
  "collab.members.remove.response": "workspace.manage",
  "collab.members.set.response": "workspace.manage",
  "collab.presence.beat.response": "workspace.read",
  "collab.workspace.enable.response": "workspace.manage",
  "collab.turn.send.response": "workspace.write",
  "collab.turn.cancel.response": "workspace.write",
  "collab.timeline.get.response": "workspace.read",
  "collab.stream.token.response": "workspace.read",
  "collab.subscription.poll.response": "workspace.read",
  ...
  "daemon.runtime.get_status.response": "daemon.read",
  "daemon.runtime.install.response": "daemon.manage",
  "local_plane.attach_token.create.response": "workspace.write",
  "orchestration.operation.cancel.response": "workspace.write",
  "orchestration.operation.get.response": "workspace.read",
  "orchestration.operation.list.response": "workspace.read",
