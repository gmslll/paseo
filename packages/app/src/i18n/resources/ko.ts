...
export const ko: TranslationResources = {
  ...
  panels: {
    ...
    diff: {
      ...
      turnSubtitle: "턴 diff",
      turnChanges: "변경 · {{count}}",
      turnCapabilityMissing: "호스트를 업데이트해야 턴 diff를 볼 수 있습니다.",
  ...
  settings: {
    ...
    runtimes: {
      title: "에이전트 런타임",
      info: "회사가 고정하고 이 호스트에 설치해 실행하는 Claude Code와 Codex 버전입니다.",
      unavailable: "에이전트 런타임을 보려면 이 호스트에 연결하세요",
      loading: "불러오는 중...",
      empty: "고정된 런타임 없음",
      install: "설치",
      installing: "설치 중...",
      activeVersion: "버전 {{version}}",
      pinnedVersion: "고정 {{version}}",
      statuses: {
        installed: "설치됨",
        installing: "설치 중",
        notInstalled: "설치 안 됨",
