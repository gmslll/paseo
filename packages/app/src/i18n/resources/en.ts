export const en = {
  ...
  panels: {
    ...
    diff: {
      ...
      turnChanges: "Changes · {{count}}",
      turnCapabilityMissing: "Update the host to view per-turn diffs.",
  ...
  settings: {
    ...
    runtimes: {
      ...
      info: "Company-pinned Claude Code and Codex versions that this host installs and runs.",
      unavailable: "Connect to this host to see Agent runtimes",
      loading: "Loading...",
      empty: "No pinned runtimes",
      install: "Install",
      installing: "Installing...",
