...
export const ja: TranslationResources = {
  ...
  panels: {
    ...
    diff: {
      ...
      turnSubtitle: "ターン差分",
      turnChanges: "変更 · {{count}}",
      turnCapabilityMissing: "ホストを更新してターン差分を表示してください。",
  ...
  settings: {
    ...
    runtimes: {
      title: "エージェントランタイム",
      info: "会社が固定し、このホストにインストールして実行する Claude Code と Codex のバージョン。",
      unavailable: "エージェントランタイムを見るにはこのホストに接続してください",
      loading: "読み込み中...",
      empty: "固定されたランタイムはありません",
      install: "インストール",
      installing: "インストール中...",
      activeVersion: "バージョン {{version}}",
      pinnedVersion: "固定 {{version}}",
      statuses: {
        installed: "インストール済み",
        installing: "インストール中",
