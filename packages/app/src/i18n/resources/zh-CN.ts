...
export const zhCN: TranslationResources = {
  ...
  panels: {
    ...
    diff: {
      ...
      commitSubtitle: "提交差异",
      turnSubtitle: "本轮差异",
      turnChanges: "更改 · {{count}}",
      turnCapabilityMissing: "请更新主机以查看本轮差异。",
  ...
  settings: {
    ...
    runtimes: {
      title: "Agent 运行时",
      info: "由公司锁定、在这个 Host 上安装和运行的 Claude Code 与 Codex 版本。",
      unavailable: "连接到这个 Host 以查看 Agent 运行时",
      loading: "正在加载...",
      empty: "暂无锁定的运行时",
      install: "安装",
      installing: "正在安装...",
      activeVersion: "版本 {{version}}",
      pinnedVersion: "锁定 {{version}}",
      statuses: {
        installed: "已安装",
        installing: "正在安装",
        notInstalled: "未安装",
