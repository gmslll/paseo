...
export const fr: TranslationResources = {
  ...
  panels: {
    ...
    diff: {
      ...
      turnSubtitle: "Diff du tour",
      turnChanges: "Modifications · {{count}}",
      turnCapabilityMissing: "Mettez à jour l'hôte pour voir les diffs par tour.",
  ...
  settings: {
    ...
    runtimes: {
      title: "Runtimes d'agents",
      info: "Versions de Claude Code et Codex fixées par l'entreprise que cet hôte installe et exécute.",
      unavailable: "Connectez-vous à cet hôte pour voir les runtimes d'agents",
      loading: "Chargement...",
      empty: "Aucun runtime fixé",
      install: "Installer",
      installing: "Installation...",
      activeVersion: "Version {{version}}",
      pinnedVersion: "Fixée {{version}}",
      statuses: {
        installed: "Installé",
