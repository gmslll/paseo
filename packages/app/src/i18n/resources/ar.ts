...
export const ar: TranslationResources = {
  ...
  panels: {
    ...
    diff: {
      ...
      turnSubtitle: "فروقات الدورة",
      turnChanges: "التغييرات · {{count}}",
      turnCapabilityMissing: "حدّث المضيف لعرض فروقات كل دورة.",
  ...
  settings: {
    ...
    runtimes: {
      ...
      info: "إصدارات Claude Code وCodex التي تحددها الشركة ويثبّتها هذا المضيف ويشغّلها.",
      unavailable: "اتصل بهذا المضيف لعرض بيئات تشغيل الوكلاء",
      loading: "جارٍ التحميل...",
      empty: "لا توجد بيئات تشغيل محددة",
      install: "تثبيت",
      installing: "جارٍ التثبيت...",
      activeVersion: "الإصدار {{version}}",
      pinnedVersion: "الإصدار المحدد {{version}}",
      statuses: {
        installed: "مثبّتة",
        installing: "جارٍ التثبيت",
        notInstalled: "غير مثبّتة",
