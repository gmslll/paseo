...
export const ptBR: TranslationResources = {
  ...
  panels: {
    ...
    diff: {
      ...
      turnSubtitle: "Diff do turno",
      turnChanges: "Alterações · {{count}}",
      turnCapabilityMissing: "Atualize o host para ver os diffs por turno.",
  ...
  settings: {
    ...
    runtimes: {
      ...
      info: "Versões do Claude Code e do Codex fixadas pela empresa que este host instala e executa.",
      unavailable: "Conecte-se a este host para ver os runtimes de agentes",
      loading: "Carregando...",
      empty: "Nenhum runtime fixado",
      install: "Instalar",
      installing: "Instalando...",
      activeVersion: "Versão {{version}}",
      pinnedVersion: "Fixada {{version}}",
      statuses: {
        installed: "Instalado",
        installing: "Instalando",
