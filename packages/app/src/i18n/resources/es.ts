...
export const es: TranslationResources = {
  ...
  panels: {
    ...
    diff: {
      ...
      turnSubtitle: "Diff del turno",
      turnChanges: "Cambios · {{count}}",
      turnCapabilityMissing: "Actualiza el host para ver los diffs por turno.",
  ...
  settings: {
    ...
    runtimes: {
      ...
      info: "Versiones de Claude Code y Codex fijadas por la empresa que este host instala y ejecuta.",
      unavailable: "Conéctate a este host para ver los runtimes de agentes",
      loading: "Cargando...",
      empty: "No hay runtimes fijados",
      install: "Instalar",
      installing: "Instalando...",
      activeVersion: "Versión {{version}}",
      pinnedVersion: "Fijada {{version}}",
      statuses: {
        installed: "Instalado",
        installing: "Instalando",
