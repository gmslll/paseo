...
export const ru: TranslationResources = {
  ...
  panels: {
    ...
    diff: {
      ...
      turnSubtitle: "Diff хода",
      turnChanges: "Изменения · {{count}}",
      turnCapabilityMissing: "Обновите хост, чтобы смотреть diff каждого хода.",
  ...
  settings: {
    ...
    runtimes: {
      ...
      info: "Закреплённые компанией версии Claude Code и Codex, которые этот хост устанавливает и запускает.",
      unavailable: "Подключитесь к этому хосту, чтобы увидеть среды выполнения агентов",
      loading: "Загрузка...",
      empty: "Нет закреплённых сред выполнения",
      install: "Установить",
      installing: "Установка...",
      activeVersion: "Версия {{version}}",
      pinnedVersion: "Закреплена {{version}}",
      statuses: {
        installed: "Установлена",
